classdef module_Parameter_MIMO < handle
    ...
    methods (Static)
        function obj = module_Parameter_MIMO(init)
            ...
            calc(obj);
            % related to CDL
            obj.theta_v = init.theta_v; %45; % travel elevation angle
            obj.phi_v = init.phi_v; %45; % travel azimuth angle ; two angles form the direction of the velocity
            % this goes for doppler part...
            %obj.t = 0:1:obj.num_symb-1; % put desired current time w.r.t. OFDM symbol
            %obj.t = obj.t*(1e-3/(2^(obj.mu))); 
